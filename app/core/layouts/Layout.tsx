...
const Layout: BlitzLayout<{ title?: string; children?: React.ReactNode }> = ({ title, children }) => {
	return (
		<React.Fragment>
			...
			<div className="h-full w-full p-6 sm:p-20 lg:p-28 bg-background items-center relative">
				<div className="absolute t-200 l-500 opacity-100">
				...
				<div className="h-full z-50 p-6 sm:p-12 lg:p-20">{children}</div>
			</div>
		</React.Fragment>
	);
};
